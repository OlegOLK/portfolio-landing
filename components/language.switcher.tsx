...
export default function LanguageSwitcher({ reverseColor }: Props) {
    ...
    return (
        ...
        <Listbox value={selected} onChange={handleChange}>
            ...
            <Listbox.Button className={cx("flex justify-end items-center w-full text-right bg-none border-0 text-base font-semibold",
            ...
            <Transition
                ...
                leaveTo="opacity-0"
            >
                <Listbox.Options className="absolute w-16 mt-1 overflow-auto text-base bg-white shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
